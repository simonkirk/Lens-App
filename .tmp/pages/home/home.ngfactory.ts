...
class _View_HomePage0 extends import1.AppView<import0.HomePage> {
  ...
  _NavPush_33_5:import19.Wrapper_NavPush;
  _text_34:any;
  _text_35:any;
  _el_36:any;
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Header_0_3 = new import13.Wrapper_Header(this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_0),this.renderer,this.parentInjector.get(import22.ViewController,(null as any)));
    ...
    this._Navbar_2_4 = new import14.Wrapper_Navbar(this.parentInjector.get(import23.App),this.parentInjector.get(import22.ViewController,(null as any)),this.parentInjector.get(import8.NavController,(null as any)),this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_2),this.renderer);
    ...
    this._Content_9_4 = new import16.Wrapper_Content(this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_9),this.renderer,this.parentInjector.get(import23.App),this.parentInjector.get(import25.Keyboard),this.parentInjector.get(import26.NgZone),this.parentInjector.get(import22.ViewController,(null as any)),this.parentInjector.get(import27.Tabs,(null as any)));
    ...
    this._Button_30_4 = new import18.Wrapper_Button((null as any),'',this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_30),this.renderer);
    ...
    this._Button_33_4 = new import18.Wrapper_Button((null as any),'',this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_33),this.renderer);
    this._NavPush_33_5 = new import19.Wrapper_NavPush(this.parentInjector.get(import8.NavController,(null as any)));
    ...
    this._Button_36_4 = new import18.Wrapper_Button((null as any),'',this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_36),this.renderer);
    ...
    this._Button_39_4 = new import18.Wrapper_Button((null as any),'',this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_39),this.renderer);
    ...
    this._Button_42_4 = new import18.Wrapper_Button((null as any),'',this.parentInjector.get(import20.Config),new import21.ElementRef(this._el_42),this.renderer);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import30.Col) && ((15 <= requestNodeIndex) && (requestNodeIndex <= 21)))) { return this._Col_15_3.context; }
    if (((token === import30.Row) && ((13 <= requestNodeIndex) && (requestNodeIndex <= 22)))) { return this._Row_13_3.context; }
    if (((token === import31.Button) && ((30 <= requestNodeIndex) && (requestNodeIndex <= 31)))) { return this._Button_30_4.context; }
    if (((token === import31.Button) && ((33 <= requestNodeIndex) && (requestNodeIndex <= 34)))) { return this._Button_33_4.context; }
    if (((token === import32.NavPush) && ((33 <= requestNodeIndex) && (requestNodeIndex <= 34)))) { return this._NavPush_33_5.context; }
    if (((token === import31.Button) && ((36 <= requestNodeIndex) && (requestNodeIndex <= 37)))) { return this._Button_36_4.context; }
    if (((token === import31.Button) && ((39 <= requestNodeIndex) && (requestNodeIndex <= 40)))) { return this._Button_39_4.context; }
    if (((token === import31.Button) && ((42 <= requestNodeIndex) && (requestNodeIndex <= 43)))) { return this._Button_42_4.context; }
    if (((token === import30.Col) && ((26 <= requestNodeIndex) && (requestNodeIndex <= 46)))) { return this._Col_26_3.context; }
    if (((token === import30.Row) && ((24 <= requestNodeIndex) && (requestNodeIndex <= 47)))) { return this._Row_24_3.context; }
    if (((token === import30.Grid) && ((11 <= requestNodeIndex) && (requestNodeIndex <= 48)))) { return this._Grid_11_3.context; }
    if (((token === import33.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 49)))) { return this._Content_9_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_10:any = this.context.sphere;
    ...
    const currVal_14:any = 'lens-dark';
    ...
    const currVal_17:any = 'lens-dark';
  ...
  private _handle_click_33_0($event:any):boolean {
    this.markPathToRootAsCheckOnce();
    const pd_0:any = ((<any>this._NavPush_33_5.context.onClick()) !== false);
    return (true && pd_0);
  }
